    ...
    public void onClick(View v) {
        if (v.getId() == R.id.backa) {
            ...
            if("eggs".equalsIgnoreCase(name)) {
                ...
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.butter, R.drawable.ingredient_butter));
            } else if("cheese".equalsIgnoreCase((name))) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.cheese, R.drawable.ingredient_cheese));
            } else if("chicken".equalsIgnoreCase(name)) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.chicken, R.drawable.ingredient_chicken));
            } else if("milk".equalsIgnoreCase((name))) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.milk, R.drawable.ingredient_milk));
            } else if("garlic".equalsIgnoreCase(name)) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.garlic, R.drawable.ingredient_garlic));
            } else if("cilantro".equalsIgnoreCase((name))) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.herb, R.drawable.ingredient_herb));
            } else if("Olive Oil".equalsIgnoreCase(name)) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.olive_oil, R.drawable.ingredient_olive_oil));
            } else if("onion".equalsIgnoreCase((name))) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.onion, R.drawable.ingredient_onion));
            } else if("bell pepper".equalsIgnoreCase(name)) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.paprika, R.drawable.ingredient_paprika));
            } else if("salt".equalsIgnoreCase((name))) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.salt, R.drawable.ingredient_salt));
            } else if("spice".equalsIgnoreCase((name))) {
                FridgeActivity.ingredientArrayList.add(new Ingredient(R.string.spice, R.drawable.ingredient_spice));
            } else {
